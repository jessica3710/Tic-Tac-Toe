 ...
 * @author Jessica
 */
public class aiHard extends javax.swing.JFrame {
    ...
    //checks if two out of three spots are empty and if the other one is an O
    //when spot is empty, places it in one of the spots and attacks the human, making them block you or allows you to win
    private boolean attack(int first, int second, int third) {
        return (ai[first] == ai[second] && ai[first] == 2 && ai[third] == 0);
    }
    ...
    //checks for win spots, then defends by blocking, or attacks the human, if none apply then chooses a randomized empty spot
    private void aIntelligence() {
        ...
        //all combinations for blocking the human from winning
            ...
            fillSquare(5);
        } //if unable to win immediately or block their move, makes a move that may put the human in threat
        //all combinations to attack the human 
        else if (attack(1, 2, 0)) {
            fillSquare(1);
        } else if (attack(0, 2, 1)) {
            fillSquare(0);
        } else if (attack(0, 1, 2)) {
            fillSquare(0);
        } else if (attack(3, 4, 5)) {
            fillSquare(4);
        } else if (attack(3, 5, 4)) {
            fillSquare(5);
        } else if (attack(4, 5, 3)) {
            fillSquare(4);
        } else if (attack(6, 7, 8)) {
            fillSquare(6);
        } else if (attack(6, 8, 7)) {
            fillSquare(6);
        } else if (attack(7, 8, 6)) {
            fillSquare(8);
        } else if (attack(0, 3, 6)) {
            fillSquare(0);
        } else if (attack(3, 6, 0)) {
            fillSquare(6);
        } else if (attack(0, 6, 3)) {
            fillSquare(0);
        } else if (attack(1, 4, 7)) {
            fillSquare(4);
        } else if (attack(4, 7, 0)) {
            fillSquare(4);
        } else if (attack(1, 7, 0)) {
            fillSquare(1);
        } else if (attack(2, 5, 8)) {
            fillSquare(2);
        } else if (attack(5, 8, 2)) {
            fillSquare(8);
        } else if (attack(2, 8, 5)) {
            fillSquare(2);
        } else if (attack(0, 4, 8)) {
            fillSquare(4);
        } else if (attack(4, 8, 0)) {
            fillSquare(4);
        } else if (attack(0, 8, 4)) {
            fillSquare(0);
        } else if (attack(2, 4, 6)) {
            fillSquare(4);
        } else if (attack(4, 6, 2)) {
            fillSquare(4);
        } else if (attack(6, 2, 4)) {
            fillSquare(2);
        } else {
    ...
    private void playTurns(int buttonNumber, JButton buttonText) {
        ...
        if (winner == false) {
            ...
            if (counter < 8 && winner == false) {
                ...
                aIntelligence(); //checks if the computer won first, defends the human, attacks, or generate a random number and places it there
                winner = win(counter); //checks for a winner
    ...
    private void replayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_replayActionPerformed
        //closes the current screen and shows another hard mode screen that is reset
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aiHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
